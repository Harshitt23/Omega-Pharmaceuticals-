        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <ScrollReveal delay={150}>
            ...
            >
              ...
              <button
                type="submit"
                className="btn-primary group mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-linear-to-r from-pharma-600 to-pharma-700 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 sm:w-auto"
              >
                Submit
